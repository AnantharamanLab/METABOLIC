...
`Rscript $METABOLIC_dir/draw_biogeochemical_cycles.R $output/METABOLIC_Figures_Input.$second_run_suffix/Nutrient_Cycling_Diagram_Input $output/Output TRUE > /dev/null`;
...
`Rscript $METABOLIC_dir/draw_metabolic_Sankey_diagram.R $output/METABOLIC_Figures_Input.$second_run_suffix/Metabolic_Sankey_diagram_input.txt $output/Output_energy_flow > /dev/null`;
...
`Rscript $METABOLIC_dir/draw_functional_network_diagram.R $output/METABOLIC_Figures_Input.$second_run_suffix/Functional_network_input.txt $output/OutputFolder_Energy > /dev/null`;
